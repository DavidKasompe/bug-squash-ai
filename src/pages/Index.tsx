          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            <div className="text-center animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                BugSquash.AI automatically detects, analyzes, and suggests fixes for bugs in your code
                using advanced AI models. Save hours of debugging time.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/upload">
                  <Button size="lg" className="bg-primary hover:bg-primary/90 font-medium px-8 glow-effect">
                    Upload Logs
                  </Button>
                </Link>
              ...
              <div className="relative rounded-md bg-secondary/30 overflow-hidden">
                ...
                <div className="pt-8 p-6 font-mono text-sm text-muted-foreground">
                  <pre className="whitespace-pre-wrap">
                    <span className="text-primary">&gt;</span> Analyzing application logs...{'\n'}
                    <span className="text-yellow-500">WARN</span> Memory leak detected in userAuthentication.js{'\n'}
                    <span className="text-destructive">ERROR</span> Uncaught TypeError: Cannot read property 'id' of undefined{'\n'}
                    <span className="text-primary">&gt;</span> Generating fix...{'\n'}
                    <span className="text-accent">SOLUTION</span> Update line 42: Check if user object exists before accessing id property{'\n'}
        ...
        <section className="py-16 px-4 md:px-6 bg-background/40">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">How BugSquash.AI Works</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our AI-powered platform streamlines your debugging workflow with advanced analysis and automated fixes.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-all duration-200">
                ...
                <p className="text-muted-foreground text-sm">
                  Simply upload your application logs or error traces through our user-friendly interface.
                </p>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-all duration-200">
                ...
                <p className="text-muted-foreground text-sm">
                  Our AI engine analyzes your logs to identify bugs, their root causes, and potential impacts.
                </p>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-all duration-200">
                ...
                <p className="text-muted-foreground text-sm">
                  Review AI-generated fix suggestions with confidence scores and apply them to your codebase.
                </p>
              </div>
            </div>
          </div>
